...
token = '5919737412:AAFA4nay58b-NMt4KgJxSuCIyxP4G07_T7k'
...
def get_text_message(message):
    ...
    if message.text == 'Сгенерировать пароль':
    ...
    elif message.text == 'Оби пидор':
            bot.send_message(message.chat.id,'Сам пидор')
    elif message.text == 'Оби пидорас':
            bot.send_message(message.chat.id,'Сам пидорас')
        ...
        bot.send_message(message.chat.id,'Сам {0}'.format(message.text))
